...
function Login() {
  return (
    <div className='w-full lg:h-[70vh] md:h-[40vh] h-[30vh] bg-cover bg-center object-cover bg-no-repeat bg-[url(/img/bg.jpg)] '>
      ...
      <button className='bg-white rounded-full p-3 text-amber-600 absolute top-1 lg:right-[21%] md:right-[22%] right-4 hover:scale-110 h-12 w-12'>
         <i className='fas fa-arow-right text-black'></i>
      </button>
      </div>
